...
class MoonPhaseView(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) : View(context, attrs, defStyle) {
    var mRotate: Int = 0
        set(value) {
            field = value
            invalidate()
    ...
    init {
        val a = context.obtainStyledAttributes(
            attrs, R.styleable.MoonPhaseView, defStyle, 0
        )
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        Log.d("MoonPhase", "mRotate=$mRotate")
